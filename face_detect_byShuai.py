...
The following code heavily based on face_detector.py and the related packages needs to be installed ahead.
"""
import os
import sys
import dlib
...
if __name__ == '__main__':
    ...
    # print('First sub_image is {} and the type is {}'.format(dets[0], type(dets[0])))
    # print('The coordinate of first sub_image is ({},{}),({},{})'.format(dets[0].top(),dets[0].bottom(), dets[0].left(), dets[0].right()))
    # print(type(dets[0].top()))
